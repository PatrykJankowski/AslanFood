...
<section class="container mx-auto mb-24 px-6 grid grid-cols-1 md:grid-cols-2 gap-10">
    ...
    <div class="text-center mt-12">
        ...
        <p class="text-xl font-bold mt-4"><?php the_field('company'); ?></p>
        <p class="mt-2"><?php the_field('street', $page_id); ?>, <?php the_field('postcode', $page_id); ?> <?php the_field('city', $page_id); ?></p>
        <p class="mt-2">NIP: <?php the_field('nip', $page_id); ?></p>
        <p class="mt-2">REGON: <?php the_field('regon', $page_id); ?></p>
